...
In the research record retain source URLs/document identifiers, publication and
observation times, fiscal periods, relevant figures, calculation inputs and
concise evidence-based rationale. Separate facts, estimates, hypotheses and
unverified claims. Preserve enough to reproduce conclusions without copying full
articles, raw feeds or private deliberation transcripts. Cite or link unchanged
historical evidence rather than duplicating it every day.

## Four distinct setup tests

For earnings-based ideas, establish revenue, earnings basis, guidance, margins,
cash generation and the central operating metrics. Match fiscal periods and
GAAP/non-GAAP bases; identify unusual items, recurring costs, dilution and changed
definitions. A surprise requires a verifiable **pre-announcement** expectation
snapshot: a current consensus page may already incorporate results. If unavailable,
leave the beat/miss unverified instead of inventing one.
...
as a claim to test against results, not proof. Missing transcripts or incomparable
metrics remain explicit gaps.
